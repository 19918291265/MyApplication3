...
public class MyAdapter_comment extends RecyclerView.Adapter<MyAdapter_comment.ViewHolder>{
    ...
    public MyAdapter_comment(Context context, List<Map<String, Object>> list) {
    ...
    @NonNull
    @Override
    public MyAdapter_comment.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.news_item, parent, false);

        return new MyAdapter_comment.ViewHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull MyAdapter_comment.ViewHolder holder, final int position) {
